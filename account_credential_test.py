...
class TestCredential(unittest.TestCase):
  ...
  def setUp(self):
    ...
    '''
    self.new_credential = Credential("TestUser","Password","0700000000") #creating credential object
  ...
  def test_init(self):
    ...
    self.assertEqual(self.new_credential.credential_name,"TestUser")
    self.assertEqual(self.new_credential.password,"Password")
    self.assertEqual(self.new_credential.number,"0700000000")
  ...
  def test_save_multiple_credential(self):
    ...
    test_credential = Credential("AdminUser","AdminPass","0722222222") #new credential
  ...
  def test_find_credential_by_number(self):
    '''
    test to check if we can find a credential by phone_number number and display information
    '''
    ...
    found_credential = Credential.find_credential_by_number("0722222222")
  ...
  def test_credential_exists(self):
    ...
    credential_exists = Credential.credential_exist("0722222222")
  ...
  def test_copy_email(self):
        ...
        self.new_credential.save_credential()
        Credential.copy_pwd("0700000000")
